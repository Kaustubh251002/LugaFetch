...
const apiUrl = 'https://kusama.api.subscan.io/api/scan/staking/validator/bond_stat'; // Replace with the API endpoint URL
...
const requestData = {
  "stash": "E8MByjWbS49hmzFM1U5rvFJES1Xgz1TSBAZLiYqZQiFTNUY" // LUGANODES STASH VALUE
};
